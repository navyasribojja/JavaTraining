...
public class Fifth_Employee {
	protected String Employee_Name;
	protected String Department_of_Employee;
	protected String Designation;
	protected int Salary;
	public Fifth_Employee() {
		super();
	}
	public Fifth_Employee(String employee_Name, String department_of_Employee, String designation, int salary) {
		super();
